  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-stone-950/90 backdrop-blur-xl border-b-2 border-stone-800">
      <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
        <div className="flex items-center space-x-3 relative group cursor-pointer" onClick={() => { setActiveTab('landing'); window.scrollTo({ top: 0, behavior: 'smooth' }); }}>
          {/* 仿 Logo 的手繪圓形 */}
        ...
        <div className="hidden md:flex items-center space-x-8 text-sm font-bold text-stone-400 font-sans tracking-wide">
          ...
          <a href="https://www.instagram.com/direct/t/[IG_ID佔位符]" target="_blank" rel="noopener noreferrer" className="inline-block bg-amber-100 text-stone-950 px-5 py-2.5 rounded-organic-2 border-2 border-amber-200 font-black font-serif hover:bg-white hover:-translate-y-0.5 transition-all duration-300 shadow-lg hover:shadow-xl">
            聯絡我們
          </a>
        </div>
      </div>
